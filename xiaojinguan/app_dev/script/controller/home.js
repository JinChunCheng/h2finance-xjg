    ...
    $(document).on('pageInit', '#home-ctt', function() {
        ...
        var IndexView = Backbone.View.extend({
            ...
            render: function() {
                ...
                $(".bar-bottom-tab").off("click");
                $(".bar-bottom-tab").on("click", function() {
            ...
            renderChart: function() {
                ...
                var option = {
                    ...
                    xAxis: [{
                        ...
                        type: 'category',
                        boundaryGap: false,
                        data: [FormatDateNoYear(chart[6].recordDate), FormatDateNoYear(chart[5].recordDate), FormatDateNoYear(chart[4].recordDate), FormatDateNoYear(chart[3].recordDate), FormatDateNoYear(chart[2].recordDate), FormatDateNoYear(chart[1].recordDate), FormatDateNoYear(chart[0].recordDate)],
                    }],
                    yAxis: [{
                        type: 'value',
                        min: minValue,
